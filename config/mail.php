...
return [
    ...
    */
    ...
    'mailers' => [
        ...
        'sendgrid' => [
            'transport' => 'smtp',
            'host' => env('SENDGRID_MAIL_HOST', 'smtp.mailgun.org'),
        ...
        'sparkpost' => [
            'transport' => 'smtp',
            'host' => env('SPARKPOST_MAIL_HOST', 'smtp.mailgun.org'),
            'port' => env('SPARKPOST_MAIL_PORT', 587),
            'encryption' => env('SPARKPOST_MAIL_ENCRYPTION', 'tls'),
